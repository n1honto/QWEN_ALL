...
from ui.tabs import tab_control, tab_user, tab_fo, tab_cb, tab_user_data, tab_tx_data, tab_offline_tx, tab_smart_contracts, tab_consensus, tab_blockchain, tab_metrics
...
class MainApplication(tk.Tk):
    ...
    def __init__(self, db_manager, blockchain, central_bank, financial_orgs, users, replicas, network, simulation_controller):
        ...
        self.tab_control_frame = tab_control.ControlTab(
            ...
            self  # --- ДОБАВЛЕНО: передаём экземпляр MainApplication ---
        )
    ...
    # ... (до метода update_all_tabs_data) ...
    ...
    def update_simulation_objects(self, db_manager, blockchain, central_bank, financial_orgs, users, replicas, network):
        ...
        # Проверим, инициализированы ли атрибуты вкладок перед обновлением
